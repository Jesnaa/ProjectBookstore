...
function cityValidation(inputTxt){
    ...
    var regx = /^[a-zA-Z\s, ]+$/;
    var textField = document.getElementById("citys");
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 2){
            ...
            textField.textContent = 'Please enter a valid city';
            textField.style.color = "red";
        }
    }else{
...
function stateValidation(inputTxt){
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 2){
            ...
            textField.textContent = 'Please enter a valid state';
            textField.style.color = "red";
        }
    }else{
        textField.textContent = 'your input is empty';
...
function countryValidation(inputTxt){

    var regx = /^[a-zA-Z]+$/;
    var textField = document.getElementById("countrys");
    ...
    if(inputTxt.value != '' ){
        ...
        if(inputTxt.value.length >= 2){
            ...
            textField.textContent = 'Please enter a valid country';
            textField.style.color = "red";
        }
    }else{
        textField.textContent = 'your input is empty';
...
function pincodeValidation(inputTxt){
    ...
    var regx = /^[1-9][0-9]{5}$/;
    var textField = document.getElementById("pincodes");
